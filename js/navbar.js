  			...
  			<div class="col-right">
  				<a href="#" style="z-index:5">
  					<div class="navIcon">
  						...
  						<div class="close">
  							<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Layer_2" x="0px" y="0px" width="27px" height="27px" viewBox="0 0 27 27" enable-background="new 0 0 27 27" xml:space="preserve">
  		...
  		<div class="container">
  			<div class="row">
  				<div class="col-sm-6 col-xs-6">
  					...
  					<ul class="menu">
  						<a class="smoothTransition" href="wanderlust.html">
  							<li>
  								<h1 class="mobile-links">Wanderlust</h1>
  							</li>
  						</a>
